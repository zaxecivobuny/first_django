...
HOSTNAME=`hostname`
POSTGRESQL_PIDFILE=/Users/zaxecivobuny/first_django/bin/postgresql/data/postmaster.pid

POSTGRESQL_START="/Users/zaxecivobuny/first_django/bin/postgresql/bin/pg_ctl start -w -D /Users/zaxecivobuny/first_django/bin/postgresql/data"
POSTGRESQL_STOP="/Users/zaxecivobuny/first_django/bin/postgresql/bin/pg_ctl stop -D /Users/zaxecivobuny/first_django/bin/postgresql/data"
...
start_postgresql() {
    ...
    if [ $ERROR -eq 0 ]; then
	echo "$0 $ARG: postgresql  started at port 5433"
	sleep 2
    else
